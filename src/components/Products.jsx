    ...
    <section className="py-16 md:py-24 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-12 gap-4">
                <div>
                    <span className="text-primary font-label-caps mb-2 md:mb-4 block text-xs md:text-sm">CATALOGUE</span>
                    <h2 className="font-headline-lg text-3xl md:text-5xl lg:text-6xl text-white">Industrial Solutions</h2>
                </div>
                <a className="text-primary hover:text-white transition-colors font-label-caps border-b border-primary pb-1 text-xs md:text-sm"
                    href="#">VIEW ALL SPECIFICATIONS</a>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
                ...
                <div className="md:col-span-8 glass-card rounded-3xl overflow-hidden relative group cursor-pointer">
                    ...
                    <div
                        ...
                        <h3 className="text-3xl font-black text-white mb-2">Steel Coils</h3>
                        <p className="text-on-surface-variant max-w-md">Premium cold-rolled and hot-dip galvanized coils for
                            high-precision manufacturing.</p>
                    </div>
                </div>
                {/* Small Product 1 */}
                <div className="md:col-span-4 glass-card rounded-3xl overflow-hidden relative group cursor-pointer">
                    ...
                    <div
                        ...
                        <h3 className="text-xl font-bold text-white mb-1">Structural Steel</h3>
                        <p className="text-xs text-on-surface-variant">I-Beams, channels, and angles.</p>
                    </div>
                </div>
                {/* Small Product 2 */}
                <div className="md:col-span-4 glass-card rounded-3xl overflow-hidden relative group cursor-pointer">
                    ...
                    <div
                        className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-surface to-transparent">
                        <h3 className="text-xl font-bold text-white mb-1">Pipes &amp; Tubes</h3>
                        <p className="text-xs text-on-surface-variant">Seamless hydraulic &amp; structural tubing.</p>
                    </div>
                </div>
                {/* Small Product 3 */}
                <div className="md:col-span-8 glass-card rounded-3xl overflow-hidden relative group cursor-pointer">
                    ...
                    <div
                        className="absolute inset-0 p-10 flex flex-col justify-end bg-gradient-to-t from-surface to-transparent">
                        <h3 className="text-2xl font-bold text-white mb-2">Industrial Sheets</h3>
                        <p className="text-sm text-on-surface-variant">Custom-cut heavy plates and specialized alloy sheets.
                        </p>
                    </div>
                </div>
            </div>
