  ...
  return (
    <section className="py-16 md:py-24 bg-slate-950">
        <div className="max-w-7xl mx-auto px-8">
                        <h2 className="text-3xl md:text-6xl font-bebas tracking-wider text-white mb-12 md:mb-20 text-center">{t('process.title')}</h2>
            <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                    <div className="text-center group">
                        ...
                        <h4 className="text-xl font-bebas tracking-widest text-white mb-3">{steps[0].title}</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">{steps[0].desc}</p>
                    </div>
                    <div className="text-center group">
                        <div
                        ...
                        <h4 className="text-xl font-bebas tracking-widest text-white mb-3">{steps[1].title}</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">{steps[1].desc}</p>
                    </div>
                    <div className="text-center group">
                        <div
                            className="w-24 h-24 mx-auto bg-white/5 rounded-full flex items-center justify-center border-4 border-slate-950 mb-8 ring-1 ring-white/10 group-hover:ring-orange-500 transition-all duration-500 group-hover:scale-110 group-hover:bg-orange-500/10 shadow-2xl">
                        ...
                        <h4 className="text-xl font-bebas tracking-widest text-white mb-3">{steps[2].title}</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">{steps[2].desc}</p>
                    </div>
                    <div className="text-center group">
                        <div
                            className="w-24 h-24 mx-auto bg-white/5 rounded-full flex items-center justify-center border-4 border-slate-950 mb-8 ring-1 ring-white/10 group-hover:ring-orange-500 transition-all duration-500 group-hover:scale-110 group-hover:bg-orange-500/10 shadow-2xl">
                        ...
                        <h4 className="text-xl font-bebas tracking-widest text-white mb-3">{steps[3].title}</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">{steps[3].desc}</p>
                    </div>
                </div>
            </div>
        </div>
