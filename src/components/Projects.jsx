  ...
  return (
    <section className="py-16 md:py-24 bg-slate-950">
        <div className="max-w-7xl mx-auto px-8">
                        <h2 className="text-3xl md:text-6xl font-bebas tracking-wider text-white mb-10 md:mb-16 text-center">{t('projects.title')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="group relative aspect-[4/5] overflow-hidden rounded-3xl">
                    ...
                    <div
                        ...
                        <span className="text-sm font-bebas tracking-[0.3em] text-orange-500 mb-2 uppercase">{cards[0].category}</span>
                        <h3 className="text-4xl font-bebas leading-[0.9] text-white mb-4 uppercase">{cards[0].titleLines[0]}<br/>{cards[0].titleLines[1]}</h3>
                        <p className="text-sm text-slate-300 leading-relaxed font-inter max-w-[280px]">{cards[0].desc}</p>
                    </div>
                </div>
                <div className="group relative aspect-[4/5] overflow-hidden rounded-3xl">
                    <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                    ...
                    <div
                        className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent p-10 flex flex-col justify-end">
                        <span className="text-sm font-bebas tracking-[0.3em] text-orange-500 mb-2 uppercase">{cards[1].category}</span>
                        <h3 className="text-4xl font-bebas leading-[0.9] text-white mb-4 uppercase">{cards[1].titleLines[0]}<br/>{cards[1].titleLines[1]}</h3>
                        <p className="text-sm text-slate-300 leading-relaxed font-inter max-w-[280px]">{cards[1].desc}</p>
                    </div>
                </div>
                <div className="group relative aspect-[4/5] overflow-hidden rounded-3xl">
                    <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                    ...
                    <div
                        className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent p-10 flex flex-col justify-end">
                        <span className="text-sm font-bebas tracking-[0.3em] text-orange-500 mb-2 uppercase">{cards[2].category}</span>
                        <h3 className="text-4xl font-bebas leading-[0.9] text-white mb-4 uppercase">{cards[2].titleLines[0]}<br/>{cards[2].titleLines[1]}</h3>
                        <p className="text-sm text-slate-300 leading-relaxed font-inter max-w-[280px]">{cards[2].desc}</p>
                    </div>
                </div>
            </div>
        </div>
