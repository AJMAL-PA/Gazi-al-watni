    ...
    <section className="py-24 md:py-32 relative overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 text-center">
            <div className="mb-16 md:mb-24">
                <span className="text-orange-500 font-inter font-bold mb-4 block uppercase tracking-[0.3em] text-xs md:text-sm">{t('industries.badge')}</span>
                <h2 className="font-bebas text-5xl md:text-7xl lg:text-8xl text-white tracking-wider">{t('industries.title')} <span className="text-orange-600">{t('industries.highlight')}</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="group relative p-10 bg-white/[0.02] border border-white/10 rounded-[3rem] hover:bg-white/[0.05] hover:border-orange-500/30 transition-all duration-700 overflow-hidden text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h3 className="text-3xl font-bebas tracking-widest text-white mb-4 group-hover:text-orange-500 transition-colors">{cards[0].title}</h3>
                        <p className="text-slate-400 font-inter text-sm leading-relaxed group-hover:text-slate-200 transition-colors">{cards[0].desc}</p>
                    </div>
                </div>
                ...
                <div className="group relative p-10 bg-white/[0.02] border border-white/10 rounded-[3rem] hover:bg-white/[0.05] hover:border-orange-500/30 transition-all duration-700 overflow-hidden text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h3 className="text-3xl font-bebas tracking-widest text-white mb-4 group-hover:text-orange-500 transition-colors">{cards[1].title}</h3>
                        <p className="text-slate-400 font-inter text-sm leading-relaxed group-hover:text-slate-200 transition-colors">{cards[1].desc}</p>
                    </div>
                </div>
                ...
                <div className="group relative p-10 bg-white/[0.02] border border-white/10 rounded-[3rem] hover:bg-white/[0.05] hover:border-orange-500/30 transition-all duration-700 overflow-hidden text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h3 className="text-3xl font-bebas tracking-widest text-white mb-4 group-hover:text-orange-500 transition-colors">{cards[2].title}</h3>
                        <p className="text-slate-400 font-inter text-sm leading-relaxed group-hover:text-slate-200 transition-colors">{cards[2].desc}</p>
                    </div>
                </div>
                ...
                <div className="group relative p-10 bg-white/[0.02] border border-white/10 rounded-[3rem] hover:bg-white/[0.05] hover:border-orange-500/30 transition-all duration-700 overflow-hidden text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h3 className="text-3xl font-bebas tracking-widest text-white mb-4 group-hover:text-orange-500 transition-colors">{cards[3].title}</h3>
                        <p className="text-slate-400 font-inter text-sm leading-relaxed group-hover:text-slate-200 transition-colors">{cards[3].desc}</p>
                    </div>
                </div>
            </div>
        </div>
